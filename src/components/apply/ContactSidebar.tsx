...
export default function ContactSidebar() {
  return (
    <div className="space-y-6 lg:sticky lg:top-24">
      {/* Contact card */}
      <div className="border border-border shadow-md bg-white dark:bg-zinc-950 overflow-hidden rounded-2xl">
        {/* Header */}
      ...
      <div className="border border-border shadow-md bg-white dark:bg-zinc-950 overflow-hidden rounded-2xl">
        ...
        <div className="p-4 bg-zinc-50 dark:bg-zinc-900 border-t border-border flex justify-between items-center">
          ...
          <a
            ...
            className="p-2 rounded-full hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors text-primary"
          >
